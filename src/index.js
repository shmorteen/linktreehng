...
class Linktree extends React.Component {
  ...
  <div className="container-fluid vh-100 vw-100">
    ...
    <div className="mx-5 d-md-flex d-none flex-row justify-content-between">
      ...
      <h6 style={{}}>HNG Internship 9 Frontend Task</h6>
      <img style={{height: 70, width: 150}}  src="https://training.zuri.team/ingresive.jpg" />
    </div>
  </div>
</>
